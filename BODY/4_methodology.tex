...
\end{equation}
The target distribution is the rhythmic template, and the generated distribution is the generated output conditioned with that rhythmic template. A small difference indicates better control. 
